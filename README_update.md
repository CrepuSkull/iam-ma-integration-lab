...
├── .gitignore                       ← Sensitive files exclusions
│
├── /docs/                           ← Methodology, playbook, compliance, prerequisites
│   ├── METHODOLOGY.md               ← IAM 360° method — principles and rationale
│   ├── MA-INTEGRATION-PLAYBOOK.md   ← End-to-end project playbook (due diligence → closure)
│   ├── USER-SURVEY.md               ← 3 user questionnaires (pre/post migration)
│   ├── Compliance-RGPD-Migration.md ← DPIA, legal basis, data retention, DPA review
│   ├── PREREQUISITES-GRAPH.md       ← Microsoft Graph setup guide
│   └── Setup-MgGraphApp.ps1         ← App Registration creation script (DryRun default)
│
...
├── /phase3-migration/               ← Provisioning to Entra ID — identity deduplication + Shadow Mode
...
├── /reports/                        ← Script output directory (gitignored — .gitkeep only)
